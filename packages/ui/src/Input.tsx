      ...
      <div className="flex">
        ...
        <div
          className={clsx(
            ...
            'focus-within:border-brand-500 bg-brand-500 flex w-full items-center dark:border-gray-700 dark:bg-gray-900'
          )}
        >
          <input
            id={id}
            className={clsx(
              ...
              'text-darker peer w-full border-none bg-transparent outline-none focus:ring-0',
              className
            )}
            type={type}
            ref={ref}
