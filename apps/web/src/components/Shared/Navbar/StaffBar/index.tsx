...
import { GIT_COMMIT_SHA, IS_MAINNET, IS_PRODUCTION } from '@lenster/data/constants';
...
export const Badge: FC<BadgeProps> = ({ children }) => (
  <span className="rounded-md bg-gray-300 px-1.5 py-0.5 text-xs font-bold dark:bg-gray-600">{children}</span>
);
